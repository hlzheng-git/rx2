...
CONFIGXRAY=https://raw.githubusercontent.com/test/test/master/etc/x.json
...
wget -qO- $CONFIGXRAY | sed -e "s/\$AUUID/$AUUID/g" -e "s/\$ParameterSSENCYPT/$ParameterSSENCYPT/g" >/x.json
